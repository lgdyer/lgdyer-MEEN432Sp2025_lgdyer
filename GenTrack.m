...
for i = 1:num_waypoints
    ...
    if (i-1) * delta_s <= straight_length 
        ...
        height(i) = exp((x(i)-450)/50) / (1+exp((x(i)-450)/50))*10; %added this equation for individual project 4
    ...
    elseif (i-1) * delta_s <= 2 * straight_length + pi * curve_radius 
        ...
        height(i) = exp((x(i)-450)/50) / (1+exp((x(i)-450)/50))*10;
